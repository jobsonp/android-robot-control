...
public class ServoRTAIInterface extends PlayerDevice  {
    ...
    /***********************************************************************
     * moveServo mueve un servo a una posicion específica.
     ...
     * valores, el primero en Unsigned INT como máscara de servo y unsigned
     * CHAR como posición de 0 a 127.
     * 
    ...
    {	
    	int mascaraServo = 0; //debería ser un unsigned int
    	/**********************************************
    	 ...
    	 * 
    	 */
    	System.out.println(" [Servo Interface] la máscara de servo es: " + (int)mascaraServo + " data: " + position);
    	//Guardar Backup
    	...
    	if (pcdata.setServo(servo, position))
    	{
            ...
            try {
            	//Según matiu el size es siempre 5
